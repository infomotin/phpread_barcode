...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">View  Product</h4>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    <tr  class="td-product_number">
                                        <th class="title"> Product Number: </th>
                                        <td class="value"><svg id="barcode"></svg></td>
                                    </tr>
                                    <span></span>
                                    <script>
                                        JsBarcode("#barcode", "<?php echo $data['product_number']?>", {
                                        format: "CODE128",
                                        //   lineColor: "#0aa",
                                        width: 3,
                                        height: 15,
                                    ...
                                    <tr  class="td-product_desc">
                                        <th class="title"> Product Desc: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-product_stock_lavel">
                                        <th class="title"> Product Stock Lavel: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-product_buy_price">
                                        <th class="title"> Product Buy Price: </th>
                                        <td class="value">
                                            <span  data-step="0.1" 
                                    ...
                                    <tr  class="td-product_sel_price">
                                        <th class="title"> Product Sel Price: </th>
                                        <td class="value">
                                            <span  data-step="0.1" 
                                    ...
                                    <a class="dropdown-item export-link-btn" data-format="print" href="<?php print_link($export_print_link); ?>" target="_blank">
                                        ...
                                        <a class="dropdown-item export-link-btn" data-format="pdf" href="<?php print_link($export_pdf_link); ?>" target="_blank">
                                            ...
                                            <a class="dropdown-item export-link-btn" data-format="word" href="<?php print_link($export_word_link); ?>" target="_blank">
                                                ...
                                                <a class="btn btn-sm btn-danger record-delete-btn mx-1"  href="<?php print_link("product/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
